<template>
  <dl class="s-item">
    <dt><a href="#"><img :src="meta.image" alt="图片正在火速赶来..." /></a></dt>
    <dd>
      <!--  -->
      <h3><router-link :to="{name: 'productDetail '}">{{ meta.title }}</router-link></h3>
      <!--  -->
      <p>
        <el-rate class="el-rate" v-model="meta.score" disabled show-score text-color="#ff9900" score-template="{value}"></el-rate>
      ...
      <p>
          ...
          <span><a href="#"><i class="el-icon-location"></i>查看地图</a></span>
      </p>
      <!--  -->
      <p>
